    ...
    for i in range(-10,10):
        ...
        for y in range(y3,y4):
            if is_black(image[y][x2+i]):
                flag1 = True
        d = d and flag1
    digits = [[True, True, True, False, True, True, True],[False, False, False, False, False, True, True],[False, True, True, True, True, True, False],[False,False,True,True,True,True,True],[True,False,False,True,False,True,True],[True,False,True,True,True,False,True],[True,True,True,True,True,False,True],[False,False,True,False,False,True,True],[True,True,True,True,True,True,True],[True,False,True,True,True,True,True],[False,False,False,False,False,False,False]]
...
def seperate_digits(rect, image):
    ...
    d1 = identify_digit(int(x1 + dx*0.19),int(x1 + dx*0.24),int(x1 + dx*0.29),int(y2+dy/10.0),int(y2+dy/3.0),int(y2+2*dy/3.0),int(y2+9*dy/10.0),image)
    d2 = identify_digit(int(x1 + dx*0.29),int(x1 + dx*0.34),int(x1 + dx*0.4),int(y2+dy/10.0),int(y2+dy/3.0),int(y2+2*dy/3.0),int(y2+9*dy/10.0),image)
    d3 = identify_digit(int(x1 + dx*0.4),int(x1 + dx*0.45),int(x1 + dx*0.5),int(y2+dy/10.0),int(y2+dy/3.0),int(y2+2*dy/3.0),int(y2+9*dy/10.0),image)
    d4 = identify_digit(int(x1 + dx*0.5),int(x1 + dx*0.55),int(x1 + dx*0.6),int(y2+dy/10.0),int(y2+dy/3.0),int(y2+2*dy/3.0),int(y2+9*dy/10.0),image)
    d5 = identify_digit(int(x1 + dx*0.6),int(x1 + dx*0.67),int(x1 + dx*0.72),int(y2+dy/10.0),int(y2+dy/3.0),int(y2+2*dy/3.0),int(y2+9*dy/10.0),image)
    d6 = identify_digit(int(x1 + dx*0.72),int(x1 + dx*0.77),int(x1 + dx*0.82),int(y2+dy/10.0),int(y2+dy/3.0),int(y2+2*dy/3.0),int(y2+9*dy/10.0),image)
...
def main():
    ...
    min_sides = 4    # Minimum number of sides (approximated) to consider as a potential square
